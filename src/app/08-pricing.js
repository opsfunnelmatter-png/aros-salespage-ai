    ...
    <section id="pricing_section" className="relative z-10 w-full bg-[#0B0F19] py-24 text-white overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="bg-[#0F1424]/90 border-2 border-transparent rounded-3xl p-6 sm:p-8 flex flex-col shadow-[0_20px_50px_rgba(249,115,22,0.15)] relative overflow-hidden">
            {/* PACKAGE HEADER */}
