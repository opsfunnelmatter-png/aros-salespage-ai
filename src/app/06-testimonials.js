      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20 max-w-4xl mx-auto space-y-5">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-white font-mono text-[10px] font-bold px-3 py-1.5 rounded uppercase tracking-widest shadow-sm">
            ...
            ANALISIS KECEKAPAN SISTEM
          </div>
          <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white leading-[1.12]">
            Perbandingan Kecekapan: <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">AROS AI Engine</span> vs Kaedah Biasa
          </h2>
          <p className="text-neutral-400 text-sm md:text-base leading-relaxed max-w-2xl mx-auto font-medium">
            Dalam perniagaan, angka adalah fakta mutlak. Berikut adalah perbandingan terus kecekapan antara kaedah staf manual, chatbot menu kaku, dan AROS Complete AI Engine.
          </p>
        </div>
            ...
            <div>
              <div className="mb-6">
                <span className="text-[10px] font-mono font-bold tracking-widest text-orange-400 uppercase bg-orange-500/10 px-2.5 py-1 rounded border border-orange-500/20">
                  PILIHAN PRESTASI TINGGI
                </span>
                <h3 className="text-xl font-black text-white mt-3">▲ AROS COMPLETE AI ENGINE</h3>
                <p className="text-xs text-neutral-400 mt-1">Sistem autopilot jualan pintar 24/7/365.</p>
              </div>
          ...
          <div className="rounded-3xl border border-white/5 bg-[#0F1424]/60 p-6 lg:p-7 relative overflow-hidden flex flex-col justify-between hover:border-white/10 transition-colors">
            <div>
              <div className="mb-6">
                ...
                <h3 className="text-xl font-black text-white mt-3 text-left">STAF MANUAL MANUSIA</h3>
                <p className="text-xs text-neutral-400 mt-1 text-left">Mengurus secara manual menggunakan tenaga staf.</p>
              </div>
          ...
          <div className="rounded-3xl border border-white/5 bg-[#0F1424]/60 p-6 lg:p-7 relative overflow-hidden flex flex-col justify-between hover:border-white/10 transition-colors">
            <div>
              <div className="mb-6">
                ...
                <h3 className="text-xl font-black text-white mt-3 text-left">CHATBOT KATA KUNCI (BOT BUTANG)</h3>
                <p className="text-xs text-neutral-400 mt-1 text-left">Menggunakan aliran kaku tanpa fungsi kecerdasan AI.</p>
              </div>
